...
class LoanedBookInstancesByUserListViewTest(TestCase):
    def setUp(self): #To modify some of these objects later
        # Create two users
    ...
    def test_redirect_if_not_logged_in(self):
        ...
        self.assertRedirects(response, '/catalog/accounts/login/?next=/catalog/mybooks/')
    ...
    def test_only_borrowed_books_in_list(self):
        ...
        for bookitem in response.context['object_list']:
